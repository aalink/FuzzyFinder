...
// console.log(userIds);
  ...
  const dogs = await Dog.insertMany([
    ...
    {
      name: "Pepper",
      description: "hi, I'm Pepper, a trained diabetic alert dog. I can sense the blood sugar level of a person and alert him/her before it becomes too dangerous. In addition, I'm a good boy and would love to play and comfort you when you're in need. ",
    ...
    {
      name: "Danny",
      description: "Hi, I'm Danny, I'm a super special Chihuahua as there're not many Chihuahuas do what I can do. I'm a PSD dog, or psychiatric service dog. I work with people with certain disabilities and help them live their lives. I think I'm a big helper!",
    ...
    {
      name: "Brady",
      description: "Hi, the name is Brady! I'm a trained allergy detector, I love my job, as I get to smell peanuts all the time. Of course I get to eat it too!!! Oh, oh, I never forget to alert my partner there're NUTS in the environment!!!",
